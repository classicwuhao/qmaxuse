...
(assert (=> (= state1_op_2 1) (= (hire a_1) true)))
(assert (=> (= state1_op_2 0) (= (hire a_0) (hire a_1))))

(assert (=> (= state2_op_1 1) (= (salary a_2) (+ (* (salary a_1)  1.0) (salary a_1)))))
(assert (=> (= state2_op_1 0) (= (salary a_2) (salary a_1))))
(assert (=> (= state2_op_2 1) (= (hire a_2) true)))
(assert (=> (= state2_op_2 0) (= (hire a_2) (hire a_1))))

(assert (=> (= state3_op_1 1) (= (salary a_3) (+ (* (salary a_2)  1.0) (salary a_2)))))
(assert (=> (= state3_op_1 0) (= (salary a_3) (salary a_2))))
(assert (=> (= state3_op_2 1) (= (hire a_3) true)))
(assert (=> (= state3_op_2 0) (= (hire a_3) (hire a_2))))
