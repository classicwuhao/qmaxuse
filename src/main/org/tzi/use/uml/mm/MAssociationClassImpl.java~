...
// $Id: MAssociationClassImpl.java 5494 2015-02-05 12:59:25Z lhamann $
...
public class MAssociationClassImpl extends MClassifierImpl implements MAssociationClass {
	...
	@Override
	public AnnotationTag getAnnotationTag(){return null;}

	@Override
	public void setAnnotationTag(AnnotationTag tag){
		; //do nothing
	}	
