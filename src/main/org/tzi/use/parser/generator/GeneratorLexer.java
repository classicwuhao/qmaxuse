// $ANTLR 3.4 Generator.g 2019-06-12 12:08:50
...
public class GeneratorLexer extends Lexer {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Generator.g:2259:3: ( ( ' ' | '\\t' | '\\f' | NEWLINE ) )
            // Generator.g:2260:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            {
            // Generator.g:2260:5: ( ' ' | '\\t' | '\\f' | NEWLINE )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mSL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Generator.g:2269:11: ( ( '//' | '--' ) (~ ( NEWLINE ) )* )
            // Generator.g:2270:5: ( '//' | '--' ) (~ ( NEWLINE ) )*
            {
            // Generator.g:2270:5: ( '//' | '--' )
            int alt2=2;
    ...
    public final void mML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Generator.g:2276:11: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // Generator.g:2277:5: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); if (state.failed) return ;



            // Generator.g:2277:10: ( options {greedy=false; } : . )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mINT() throws RecognitionException {
        try {
            // Generator.g:2314:4: ( ( '0' .. '9' )+ )
            // Generator.g:2315:5: ( '0' .. '9' )+
            {
            // Generator.g:2315:5: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
    ...
    public final void mREAL() throws RecognitionException {
        try {
            // Generator.g:2319:5: ( INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT ) )
            // Generator.g:2320:5: INT ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            {
            mINT(); if (state.failed) return ;


            // Generator.g:2320:9: ( '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )? | ( 'e' | 'E' ) ( '+' | '-' )? INT )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // Generator.g:2320:10: '.' INT ( ( 'e' | 'E' ) ( '+' | '-' )? INT )?
                    {
                    match('.'); if (state.failed) return ;
    ...
    public final void mRANGE_OR_INT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Generator.g:2322:13: ( ( INT '..' )=> INT | ( REAL )=> REAL | INT )
            int alt11=3;
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            int _type = STRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Generator.g:2329:7: ( '\\'' (~ ( '\\'' | '\\\\' ) | ESC )* '\\'' )
            // Generator.g:2330:5: '\\'' (~ ( '\\'' | '\\\\' ) | ESC )* '\\''
            {
            match('\''); if (state.failed) return ;

            // Generator.g:2330:10: (~ ( '\\'' | '\\\\' ) | ESC )*
            loop12:
            do {
                int alt12=3;
    ...
    public final void mNON_OCL_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Generator.g:2332:15: ( '\"' (~ ( '\"' | '\\\\' ) | ESC )* '\"' )
            // Generator.g:2333:5: '\"' (~ ( '\"' | '\\\\' ) | ESC )* '\"'
            {
            match('\"'); if (state.failed) return ;

            // Generator.g:2333:9: (~ ( '\"' | '\\\\' ) | ESC )*
            loop13:
            do {
                int alt13=3;
    ...
    public final void mESC() throws RecognitionException {
        try {
            // Generator.g:2346:5: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? ) )
            // Generator.g:2347:5: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            {
            match('\\'); if (state.failed) return ;

            // Generator.g:2348:6: ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '\\\\' | 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT | '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )? | '4' .. '7' ( '0' .. '7' )? )
            int alt17=11;
            switch ( input.LA(1) ) {
            case 'n':
                {
            ...
            switch (alt17) {
                ...
                case 8 :
                    ...
                    break;
                case 9 :
                    // Generator.g:2356:8: 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
                    {
                    ...
                    break;
                case 10 :
                    // Generator.g:2357:8: '0' .. '3' ( '0' .. '7' ( '0' .. '7' )? )?
                    {
                    matchRange('0','3'); if (state.failed) return ;

                    // Generator.g:2357:17: ( '0' .. '7' ( '0' .. '7' )? )?
                    int alt15=2;
                    ...
                    switch (alt15) {
                        case 1 :
                            // Generator.g:2357:18: '0' .. '7' ( '0' .. '7' )?
                            {
                            matchRange('0','7'); if (state.failed) return ;

                            // Generator.g:2357:27: ( '0' .. '7' )?
                            int alt14=2;
                    ...
                    break;
                case 11 :
                    // Generator.g:2357:45: '4' .. '7' ( '0' .. '7' )?
                    {
                    matchRange('4','7'); if (state.failed) return ;

                    // Generator.g:2357:54: ( '0' .. '7' )?
                    int alt16=2;
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // Generator.g:2363:10: ( ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' ) )
            // Generator.g:
            {
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Generator.g:2370:6: ( ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // Generator.g:2371:5: ( '$' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // Generator.g:2371:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mVOCAB() throws RecognitionException {
        try {
            // Generator.g:2378:6: ( '\\U0003' .. '\\U0377' )
            // Generator.g:
            {
    ...
    public final void synpred1_Generator_fragment() throws RecognitionException {
        // Generator.g:2323:7: ( INT '..' )
        // Generator.g:2323:9: INT '..'
        {
        mINT(); if (state.failed) return ;
    ...
    public final void synpred2_Generator_fragment() throws RecognitionException {
        // Generator.g:2324:7: ( REAL )
        // Generator.g:2324:9: REAL
        {
        mREAL(); if (state.failed) return ;
