...
import uran.formula.type.*;
import uran.solver.*;
import org.tzi.use.uran.visitor.Scope;
import org.tzi.use.uran.visitor.*;
import org.tzi.use.uran.weight.Flag;
import java.util.*;

public final class OclExprTranslator implements AbstractExprVisitor{
	private FunctionFactory factory;
	private FOLTranslator modelVisitor;	
	private Variable boundedVar = new Variable ("v", new Int()); //default variable for self keyword.
	private Scope _scope=null;
	private String navname="";
	private Flag flag;

	public OclExprTranslator(FOLTranslator v){
		this.factory = v.getFactory();
		modelVisitor=v;
	}
	
	public OclExprTranslator(FOLTranslator v, Flag flag){
		this.factory = v.getFactory();
		modelVisitor=v;
		this.flag = flag;
	}
